...
* Practice Git, GitHub, and collaborative open-source development.
* Support development across Windows and Linux platforms.

## ✨ Features

* Multiplayer quiz participation
* Player registration and score management
* MySQL database integration
* Dynamic leaderboard generation
* ASCII winner animation for top performers
...
All new features are developed through separate branches and merged using Pull Requests.
...
This project is developed for educational and open-source learning purposes.
